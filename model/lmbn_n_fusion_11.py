...
from .spectral_spatial_branch_gate import SpectralSpatialBranchGate


class LMBN_n_fusion_11(nn.Module):
    def __init__(self, args):
        super(LMBN_n_fusion_11, self).__init__()
        ...
        self.branch_gate = SpectralSpatialBranchGate(
            resize_hw=(64,64), r1=0.10, r2=0.30, mlp_hidden=256,
    ...
    def forward(self, x):
        ...
        w_br = w_br.to(device=glo.device, dtype=glo.dtype)
        glo = glo * w_br[:,0:1]; par = par * w_br[:,1:2]; cha = cha * w_br[:,2:3]
