...
class LMBN_n_par_3_partweightgate_no_residual_3(nn.Module):
    def __init__(self, args):
        super(LMBN_n_par_3_partweightgate_no_residual_3, self).__init__()
    ...
    def forward(self, x):
        ...
        p_head = p_head * weights[:, 0:1, :, :] * 3
        p_upper = p_upper * weights[:, 1:2, :, :] * 3
        p_lower = p_lower * weights[:, 2:3, :, :] * 3
