...
class LMBN_n_teacher_6_lgfu(nn.Module):
    def __init__(self, args):
        super(LMBN_n_teacher_6_lgfu, self).__init__()
        ...
        lgfu = LocalGlobalFusionUpsampler3ch()
    ...
    def forward(self, x):
        ...
        glo_x = self.lgfu_global(x)
        par_x = self.lgfu_partial(x)
        cha_x = self.lgfu_channel(x)
