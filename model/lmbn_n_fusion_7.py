...
from .dualorthogonalgates import DualOrthogonalGates


class LMBN_n_fusion_7(nn.Module):
    def __init__(self, args):
        super(LMBN_n_fusion_7, self).__init__()
        ...
        self.docg = DualOrthogonalGates(in_ch=512, hidden=256)
    ...
    def forward(self, x):
        ...
        c0, c1, reg_d = self.docg(cha)

        c0 = self.average_pooling(c0)
