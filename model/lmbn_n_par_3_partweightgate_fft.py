...
from .partwisefftgate import PartWiseFFTGate


class LMBN_n_par_3_partweightgate_fft(nn.Module):
    def __init__(self, args):
        super(LMBN_n_par_3_partweightgate_fft, self).__init__()

        self.n_ch = 2
        self.chs = 512 // self.n_ch

        self.gate = PartWiseFFTGate(in_channels=512, fft_type='amplitude')
