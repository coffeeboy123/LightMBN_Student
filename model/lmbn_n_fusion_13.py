...
from .branch_quality_gate import BranchQualityGate


class LMBN_n_fusion_13(nn.Module):
    def __init__(self, args):
        super(LMBN_n_fusion_13, self).__init__()

        self.branch_gate = BranchQualityGate(
            in_ch=3, feat_ch=512, token_ch=128, hidden=256,
            learnable_temp=True, init_T=1.0, detach_branch=True  # 먼저 True로 추천
        )
