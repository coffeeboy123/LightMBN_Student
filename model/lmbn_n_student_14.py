...
class LMBN_n_student_14(nn.Module):
    def __init__(self, args):
        super(LMBN_n_student_14, self).__init__()
        ...
        self.global_branch = nn.Sequential(nn.AvgPool2d(2, stride=2),
                                           nn.Conv2d(128, 512, kernel_size=1, bias=False),  # groups=128
                                           nn.BatchNorm2d(512),
                                           nn.ReLU(inplace=True))


        self.partial_branch = nn.Sequential(nn.AvgPool2d(2, stride=2),
                                           nn.Conv2d(128, 512, kernel_size=1, bias=False),  # groups=128
                                           nn.BatchNorm2d(512),
                                           nn.ReLU(inplace=True))

        self.channel_branch = nn.Sequential(nn.AvgPool2d(2, stride=2),
                                           nn.Conv2d(128, 512, kernel_size=1, bias=False),  # groups=128
                                           nn.BatchNorm2d(512),
                                           nn.ReLU(inplace=True))
