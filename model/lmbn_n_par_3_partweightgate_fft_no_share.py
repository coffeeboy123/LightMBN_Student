...
from .partwisefftgate import PartWiseFFTGate_no_share


class LMBN_n_par_3_partweightgate_fft_no_share(nn.Module):
    def __init__(self, args):
        super(LMBN_n_par_3_partweightgate_fft_no_share, self).__init__()

        self.n_ch = 2
        self.chs = 512 // self.n_ch

        self.gate = PartWiseFFTGate_no_share(in_channels=512, fft_type='amplitude')
        self.gate.apply(self.weights_init_kaiming)
    ...
    def forward(self, x):
        ...
        p_head, p_upper, p_lower, weights = self.gate(par)
