...
class LMBN_n_student_1(nn.Module):
    def __init__(self, args):
        super(LMBN_n_student_1, self).__init__()
        ...
        self.global_branch = nn.Sequential(copy.deepcopy(osnet.conv4),copy.deepcopy(osnet.conv5))


        self.partial_branch = nn.Sequential(copy.deepcopy(osnet.conv4),copy.deepcopy(osnet.conv5))

        self.channel_branch = nn.Sequential(copy.deepcopy(osnet.conv4),copy.deepcopy(osnet.conv5))
