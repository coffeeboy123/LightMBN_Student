...
class LMBN_n_element_bottom_no_test(nn.Module):
    def __init__(self, args):
        super(LMBN_n_element_bottom_no_test, self).__init__()
    ...
    def forward(self, x):
        ...
        f_glo_element = self.reduction_6(glo_element)
        ...
        return [f_glo_element[1], f_glo_bottom[1], f_glo[1], f_glo_drop[1], f_p0[1], f_p1[1], f_p2[1], f_c0[1], f_c1[1]], fea, torch.stack([f_glo[0], f_glo_drop[0], f_p0[0], f_p1[0], f_p2[0], f_c0[0], f_c1[0]], dim=2)
