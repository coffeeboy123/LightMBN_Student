...
from .partwisefftgate_wise import PartWiseFFTGate_wise
...
class LMBN_n_fusion_3_fft_wide(nn.Module):
    def __init__(self, args):
        ...
        self.gate = PartWiseFFTGate_wise(in_channels=512, fft_type='amplitude')
    ...
    def forward(self, x):
        ...
        p_head, p_upper, p_lower, weights = self.gate(p_par)
