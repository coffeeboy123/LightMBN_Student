...
from .partweightgate import PartWeightGate_no_share


class LMBN_n_par_3_partweightgate_no_residual_no_share(nn.Module):
    def __init__(self, args):
        super(LMBN_n_par_3_partweightgate_no_residual_no_share, self).__init__()

        self.n_ch = 2
        self.chs = 512 // self.n_ch

        self.part_gate = PartWeightGate_no_share()
