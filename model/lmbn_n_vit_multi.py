...
from .channeltransformer import ChannelTransformer, ChannelTransformer_Multi

from torch.autograd import Variable


class LMBN_n_vit_multi(nn.Module):
    def __init__(self, args):
        super(LMBN_n_vit_multi, self).__init__()
        ...
        self.channal_transformer = ChannelTransformer_Multi(channels=512)
