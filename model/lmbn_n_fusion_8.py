...
from .simplechannelsplit import SimpleChannelSplit

class LMBN_n_fusion_8(nn.Module):
    def __init__(self, args):
        super(LMBN_n_fusion_8, self).__init__()
        ...
        self.chan_split = SimpleChannelSplit(C=512, temperature=getattr(args, "split_tau", 1.0))
